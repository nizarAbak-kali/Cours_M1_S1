...
import fr.upmc.ilp.ilp1tme3.runtime.SinusStuff;
import fr.upmc.ilp.ilp1tme3.runtime.VectorStuff;
...
public class Process extends fr.upmc.ilp.ilp1.Process {
    ...
    public Process(IFinder finder) throws IOException{
        ...
        getFinder().addPossiblePath("Java/src/fr/upmc/ilp/ilp1tme3");
    }
    ...
    public void interpret() {
        try {
            ...
            final SinusStuff intt = new SinusStuff();
            intlexenv = intt.extendWithSinusPrimitive(intlexenv);
            final VectorStuff intvs = new VectorStuff();
            intlexenv = intvs.extendWithVectorPrimitives(intlexenv);
    ...
    public void compile() {
        try {
            ...
            lexenv = SinusStuff.extendWithSinusPrimitive(lexenv);
            lexenv = VectorStuff.extendWithVectorPrimitives(lexenv);
            this.ccode = compiler.compile(east, lexenv, "return");
            this.compiled = true;
    ...
    public void runCompiled() {
        try {
            ...
            String program = "bash "
                ...
                + " Java/src/fr/upmc/ilp/ilp1tme3/ilpVector.c"
                + " Java/src/fr/upmc/ilp/ilp1tme3/ilpSin.c "
